...
For debugging there is a handy tool to dump the constraints generated by executing some Wasm code

```shell
./build/constraint_trace '{"program":"./sdk/rust/target/wasm32-wasip1/release/examples/addition.wasm","args":[{"i64":3}, {"i64": 2}], "private-indices": [1]}' > addition.trace.txt
```
